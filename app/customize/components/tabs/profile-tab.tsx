  ...
  return (
    <Card className="bg-white/70 backdrop-blur-sm border-0 shadow-xl rounded-2xl">
      <CardHeader>
        ...
        <CardDescription>Set up your profile details that visitors will see</CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        <div className="flex items-center gap-6">
          ...
          <div className="flex-1">
            <Button onClick={handleAvatarUpload} variant="outline" className="rounded-xl bg-transparent">
              <Upload className="h-4 w-4 mr-2" />
              Change Avatar
            </Button>
            <p className="text-sm text-gray-500 mt-2">Upload a profile picture or use the generated avatar</p>
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          />
          <p className="text-sm text-gray-500">This will appear as @{settings.username} on your page</p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            className="rounded-xl border-2"
          />
          <p className="text-sm text-gray-500">A short description that appears under your username</p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-5 sm:grid-cols-6 md:grid-cols-7 lg:grid-cols-8 gap-2">
            {availableIcons.map((iconName) => {
              ...
              return (
                <Button
                  key={iconName}
                  variant={settings.selectedIcon === iconName ? "default" : "outline"}
                  size="icon"
          ...
          <p className="text-sm text-gray-500">Choose an icon to display next to your username</p>
        </div>
      </CardContent>
    </Card>
  )
