          ...
          <div className="w-full flex flex-col gap-2">
            <Link href={`${mainDomain}/sign-up`}>
              ...
              >
                ...
                <span className="inline-flex h-full w-full items-center justify-center whitespace-nowrap rounded-md px-8 py-2 text-white backdrop-blur-2xl">
                <Heart className="w-4 h-4 mr-2" />
                Create Your Own Page
              </span>
              </Button>
            </Link>
            <Button variant="outline" className="w-full h-10 rounded-3xl py-3 bg-transparent border border-neutral-400 text-lg shadow-lg transform transition-all hover:scale-102"  onClick={onSendAnother}>
