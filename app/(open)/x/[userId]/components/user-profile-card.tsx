...
export function UserProfileCard({ settings, userId }: UserProfileCardProps) {
    ...
    <div className="bg-white/95 backdrop-blur-sm rounded-3xl p-6 shadow-2xl border border-white/20">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-600 text-sm">{settings.pageTitle}</p>
        </div>
      ...
      <div className="bg-gradient-to-r from-pink-50 to-purple-50 rounded-2xl p-4 border border-pink-100">
        <p className="text-gray-800 font-medium text-lg leading-relaxed">{settings.customPrompt}</p>
      </div>
